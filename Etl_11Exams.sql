...
SELECT 
    ...
    DimClass.ClassID
FROM Exams
    JOIN Students ON Students.sID = Exams.sID
    JOIN Meeting ON Meeting.mID = Exams.mID
    JOIN Class ON  Class.ClassName = Students.ClassName 
    JOIN Classroom ON Classroom.RoomNumber = Meeting.RoomNumber 
    JOIN Course ON Course.cID = Meeting.cID
